    ...
    <>
      ...
      <div className="container mx-auto px-2 lg:px-12 lg:max-w-7xl mt-20 lg:mt-24">
        ...
        <div className="lg:mx-8">
          <h2 className="text-2xl font-bold mb-4">Creations from the Community</h2>
        </div>
      </div>
    </>
  );
